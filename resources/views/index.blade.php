                     ...
                     <div class="container-fluid">
                        ...
                        @foreach($products as $sp)
                           <div class="col-lg-3 col-md-6 pt-5">
                              <div class="coffee_img"><img src="/productsphotos/{{$sp->photo}}"></div>
                              <h3 class="types_text">{{$sp->name}}</h3>
                              <p class="looking_text">looking at its layout. The point of</p>
                              <div class="read_bt"><a href="/products/{{$sp->id}}">Read More</a></div>
                           </div>
                           @endforeach
         ...
         <div class="container">
            ...
            <div class="about_section_2 layout_padding">
               ...
               <div class="about_taital_box">
                  ...
                  <p class=" about_text">Cafe có thể được tìm thấy ở nhiều địa điểm khác nhau, từ quán cafe đường phố đến nhà hàng, quán cà phê, quầy bar và cả trong các cửa hàng thức ăn nhanh. Với sự phát triển của công nghệ, người ta cũng có thể tìm thấy cafe để mua và pha tại nhà.</p>
            ...
            <div class="blog_section_2">
               <div class="row">
                  <div class="col-md-6">
                     ...
                     <div class="read_bt"><a href="https://beans.at/en/kaffeewissen/kaffeezubereitungsmethoden">Read More</a></div>
                  </div>
                  <div class="col-md-6">
                     <div class="blog_box">
